		...
		return (
			<div>
				{this.state.askForUsername === true ?
				 	<div>
						<div style={{
							background: "Black", paddingBottom: "10px", width: "100%"
						}}>
							<h1 style={{ fontSize: "45px", color: "DarkGrey" }}>Video Meeting</h1>
						</div>
						<div style={{background: "DarkGrey", width: "30%", height: "auto", padding: "10px", minWidth: "200px",
						...
						<div style={{ justifyContent: "center", textAlign: "center", paddingTop: "2px" }}>
							<video id="my-video" ref={this.localVideoref} autoPlay muted style={{
								borderStyle: "solid",borderColor: "#bdbdbd",objectFit: "fill",width: "40%",height: "15%"}}></video>
						</div>
					</div>
					:
					<div>
						...
						<div className="btn-down" style={{ backgroundColor: "whitesmoke", color: "whitesmoke", textAlign: "center" }}>
							...
							<Button style={{color: "Black",marginLeft: "8px",fontSize: "10px"
								}} onClick={this.copyUrl}>Invite link</Button>
						</div>
